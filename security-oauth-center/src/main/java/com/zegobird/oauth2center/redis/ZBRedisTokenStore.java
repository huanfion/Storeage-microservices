...
@Data
@Component
public class ZBRedisTokenStore implements TokenStore {
    ...
    public ZBRedisTokenStore(RedisConnectionFactory connectionFactory) {
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        ...
        OAuth2AccessToken auth2AccessToken=deserializeAccessToken(bytes);

package com.zegobird.product.generator;
...
public class PostgreSqlGenerator {
    ...
    protected PackageConfig getPackageConfig(String aPackage) {
        ...
        pc.setModuleName(aPackage)
                .setParent("com.zegobird.product")
                .setEntity("entity")
    ...
    private GlobalConfig getGlobalConfig(boolean override, String author) {
        ...
        gc.setAuthor(author)//设置作者
                ...
                .setFileOverride(override)//是否覆盖原文件
    ...
    protected List<TableFill> getTableFills() {
        ...
        tableFillList.add(new TableFill("modifyid", FieldFill.UPDATE));
        tableFillList.add(new TableFill("modifier", FieldFill.UPDATE));
        tableFillList.add(new TableFill("modifydate", FieldFill.UPDATE));
